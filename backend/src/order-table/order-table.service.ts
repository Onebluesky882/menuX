...
import { orderTable } from 'src/database/schema';
import { CreateOrderTableDto, InsertOrdersTable } from './order-table.dto';
...
export class OrderTableService {
  ...
  async create(dto: CreateOrderTableDto, shopId: string, userId: string) {
    try {
  ...
  async update(id: string, body: InsertOrdersTable, shopId: string) {
    try {
